class Game {
  ...
  static String getHintPrompt() {
    return "Give me a hint that could help me to guess the word $word." +
        'Return the answer in the following json format: {"hint" : "<HINT>"}.' + 
        'Return to me only the json format.';
  }
